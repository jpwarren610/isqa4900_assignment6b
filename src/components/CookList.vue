            ...
            >
                    <template v-slot:item="props">
                      <tr>
                        ...
                        <td align="center"><v-icon @click="updateCook(props.item)">mdi-pencil</v-icon></td>
                        <td align="center"><v-icon @click="deleteCook(props.item)">mdi-delete</v-icon></td>
                      </tr>  
                    </template>
              </v-data-table>
              <v-data-iterator 
                      ...
                      <v-card>
                        <v-card-title class="pb-0 pt-0 pl-0">
                          ...
                          <v-col cols="3" class="text-center">
                            <v-card-actions>
                              <v-icon @click="updateCook(item)" class="small">mdi-pencil</v-icon>
                              <v-icon @click="deleteCook(item)" class="small">mdi-delete</v-icon>
                        ...
                        <v-list v-show="isExpanded(item)" dense>
                          <v-list-item>
                            <v-list-item-content class="align-end">{{ item.event_name }}</v-list-item-content>
                          </v-list-item>
                          <v-list-item>
                          ...
                          <v-list-item>
                            ...
                            <v-list-item-content class="align-end">{{ item.meat }}</v-list-item-content>
                          </v-list-item>
                        </v-list>
                      </v-card>
                    </v-col>
              ...
              <v-btn class="red darken-4 mt-4 white--text" @click="addNewCook">Add Cook</v-btn>  
        </v-col>  
      </v-row>
    </v-container>  
  </v-main>
...
<script>
 ...
 deleteCook(cook) {
        apiService.deleteCook(cook.pk).then(response => {
